    ...
    <BackgroundContainer backgroundImage={forestBG} >
      ...
      <Stack direction="row" justifyContent="center" alignItems="center" spacing={1} sx={{ width: "100%" }}>
        <Grid container spacing={1} sx={{ width: 150 }}>
          ...
          <Grid item xs={6}>
            <MenuBtn text="フレンド" Children={Diversity3} path="/problemSets" />
          </Grid>
          <Grid item xs={6}>
            <MenuBtn text="進捗" Children={Stairs} path="/problemSets" />
          </Grid>
        </Grid>
        <Button sx={{ bgcolor: "orange", color: "white", width: 120, height: 50 }} onClick={() => navigate("/idea1/learning")}>
          <Typography variant="subtitle1" color='black'>勉強開始</Typography>
        </Button>
      </Stack>
    </BackgroundContainer>
  );
